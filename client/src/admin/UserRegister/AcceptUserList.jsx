...
const AcceptUserList = () => {
  ...
  const filteredUsers = Array.isArray(data)
    ? data
      .filter((user) =>
        [user.name, user.email, user.application_no, user.username, user.mobile_no, user.region].some(
          (field) => field.toLowerCase().includes(inputs.toLowerCase())
        )
      )
      .slice(0, count) : []
        ...
        <div>
          ...
          <div>
            <div className="box_body">
              ...
              <table className=" table table table-bordered data_table">
