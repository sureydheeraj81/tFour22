  ...
  return (
    <Sidebar>
      <div className="clear">
        ...
        <div className="mb-4" onClick={exportToExcel} disabled={data.length === 0}>
          Export to Excel
        </div>
        <div>
          <div className="box_header">
            <div style={{ padding: "5px 0px" }}>
              <i className="fa-regular fa-rectangle-list mx-3"></i>&nbsp;  
              Total Users Pending for Activation: <b>{data.length}</b>
            </div>
          </div>
          <div>
