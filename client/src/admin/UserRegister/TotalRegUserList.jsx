                ...
                <tbody>
                  {filteredUsers.length > 0 ? (
                    filteredUsers.map((app, index) => {
                      ...
                      app.is_rejected == "Approved" ? "row-approved": app.is_rejected == "Rejected"? "row-rejected":"row-pending"
                           
                            
                         
                            
                            
                      return   (<tr key={app.sno} className={getStatusClass} >
                        <td>{index + 1}</td>
