...
const AdminDashboard = () => {
  ...
  const registrationCards = [
    ...
    {
      counts: regData.filter((elem) => elem.status === "Approved" && elem.region === "region-1").length,
      message1: "Region-1",
      message2: "Registered Users",
      to: "user-r1-list",
    },
    {
      counts: regData.filter((elem) => elem.status === "Approved" && elem.region === "region-2").length,
      message1: "Region-2",
      message2: "Registered Users",
      to: "user-r2-list",
    },
  ...
  const subcriptionCards = [
    ...
    {
      counts: subsData.filter((elem)=> elem.region_name==="1" && elem.status==="Approved").length,
      message1: "Region-1",
      message2: "Request Accepted",
      to: "subscription-r1-list",
    },
    {
      counts: subsData.filter((elem)=> elem.region_name==="2" && elem.status==="Approved").length,
      message1: "Region-2",
      message2: "Request Accepted",
