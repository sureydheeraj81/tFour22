            ...
            <nav id="sub-navigation" className="sidebar mt-1">
              <ul className="nav nav-pills flex-column">
                ...
                <li
                  className={`nav-item cus-nav-item  submenu-toggle  ${
                    isDropdownActive([
                      "/admin/subscriptrion-list",
                      "/admin/subscrption-accepted-list",
                      "/admin/subscrption-rejected-list",
                      "/admin/subscrption-verified-list",
                      "/admin/subscrption-pending-list",
                      "/admin/subscrption-r1-list",
                      "/admin/subscrption-r2-list",
                    ])
                      ? "active"
                      : ""
                  }`}
                ...
                <li
                  className={`nav-item cus-nav-item  ${
                    activeMenu === "user-transfer" ? "active" : ""
                  }`}
                >
                  <NavLink
