...
// User end pages
const RegisterSuccess = React.lazy(()=> import("./pages/UserRegistration/RegisterSuccess"));
const RegistrationForm = React.lazy(()=> import("./pages/UserRegistration/RegistrationForm"))
const Home = React.lazy(() => import("./pages/Home"));
const Registration = React.lazy(() => import("./pages/UserRegistration/Registration"));
...
const SubscriptionPlan =React.lazy(()=>import("./pages/Subscriptions/SubscriptionPlan"));
const UserProfilePlans=React.lazy(()=>import("./pages/Subscriptions/UserProfilePlans"));
const BharatKoshForm=React.lazy(()=>import("./pages/Subscriptions/BharatKoshForm"));
const SubsSuccess=React.lazy(()=>import("./pages/Subscriptions/SubsSuccess"));
const SubsMobVerify=React.lazy(()=>import("./pages/Subscriptions/SubsMobVerify"));
const PaymentForm=React.lazy(()=>import("./pages/Subscriptions/PaymentForm"));
...
const TotalRegUserList = React.lazy(() => import("./admin/UserRegister/TotalRegUserList"));
    ...
    <BrowserRouter>
      ...
      >
        <Routes>
          ...
          <Route path="/subs-payment" element={<PaymentForm/>}/>
